...
const INIT_STATE = {
  layoutType: layoutTypes.VERTICAL,//layoutTypes.VERTICAL,
  layoutModeType: layoutModeTypes.LIGHT,//layoutModeTypes.LIGHT,
  layoutWidth: layoutWidthTypes.FLUID,
  leftSideBarTheme: leftSideBarThemeTypes.DARK,
  leftSideBarThemeImage: leftBarThemeImageTypes.NONE,
  leftSideBarType: leftSidebarTypes.DEFAULT,
  topbarTheme: topBarThemeTypes.LIGHT,//topBarThemeTypes.LIGHT,
  isPreloader: true,
